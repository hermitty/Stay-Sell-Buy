...
if(isset($_GET["hash"])){
	...
	$sql_query = "SELECT title, category, description, price, contact, vacancy.status as status, login as added_by, user.hash as uhash, vacancy.hash as phash, photo1, photo2, photo3 ";
	$sql_query .= "FROM website.vacancy, website.user ";
	$sql_query .= "where iduser = added_by and vacancy.hash = '$hash' ";
