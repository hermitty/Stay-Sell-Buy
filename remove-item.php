	...
	if(!empty($password))
	{
		...
		else
		{
			...
			if($_SESSION['to_remove'] != NULL){
				...
				$sql_query = "DELETE FROM `website`.`item` WHERE (`hash` = '$to_remove');";
				$run_query = mysqli_query($connection, $sql_query);
				...
				$_SESSION['message'] = "The item was successfully removed";
  ...
  <div class="main_buttons">
	...
	<!-- form login -->
		<form method="post" class="text-center border border-light p-5 centre">
			...
			<p class="h3 mb-3">Write password to remove item</p>
